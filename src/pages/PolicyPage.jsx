...
const Policy = () => {
  return (
    <>
      <MetaTags
        title="Informativa sulla Privacy | SobreWeb"
        description="Informativa sulla Privacy"
        name="Informativa sulla Privacy | SobreWeb"
        locale="it_IT"
        robots="index,follow"
      ...
      <div className="min-h-screen bg-primary-900 text-slate-100">
        <div className="container mx-auto px-4 py-12">
          ...
          <p className="mb-4">
            ...
            degli utenti. Non raccogliamo informazioni personali quando visiti
            il nostro sito, quindi non memorizziamo alcun dato relativo a te.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            informazioni personali o richiedere che limitiamo il trattamento
